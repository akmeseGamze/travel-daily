  ...
  return (
    ...
    <div className='bg-purple-600 rounded-2xl overflow-hidden'>
        <div className='relative md:px-16 py-16 px-6 md:py-24'>
            {/*gradient bg */}
            <div className='absolute top-0 right-0 w-1/2 h-full bg-purple-700 clip-path-slant hidden md:block'></div>
            <div className='relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12'>
                ...
                <div className='flex flex-col sm:flex-row gap-4 sm:gap-0'>
                    <input type="email" placeholder='Enter your email address'
                        className='w-full bg-white sm:w-auto md:w-80 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-l-xl sm:rounded-r-none focus:outline-none'
                    />
                    <button className='w-full sm:w-auto cursor-pointer bg-indigo-500 text-white px-6 sm:px-6 py-3 sm:py-4 
